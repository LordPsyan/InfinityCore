...
public:
    ...
    uint8 OnCanUseItem(const Player* pPlayer, uint32 itemEntry);
    ...
    bool CorpseRemoved(Creature* me, time_t respawnDelay);
    ...
    void OnBindToInstance(Player* pPlayer, uint8 difficulty, uint32 mapid, bool permanent);
