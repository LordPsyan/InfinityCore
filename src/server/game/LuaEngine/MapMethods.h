...
namespace LuaMap
{
    ...
    int GetWorldObject(Eluna* /*E*/, lua_State* L, Map* map)
    {
        ...
        switch (GUID_HIPART(guid))
        {
            case HIGHGUID_PLAYER:
                Eluna::Push(L, ObjectAccessor::GetObjectInMap(guid, map, (Player*)NULL));
                break;
            ...
            case HIGHGUID_UNIT:
                ...
                break;
            case HIGHGUID_PET:
                Eluna::Push(L, ObjectAccessor::GetObjectInMap(guid, map, (Pet*)NULL));
                break;
            case HIGHGUID_DYNAMICOBJECT:
                Eluna::Push(L, map->GetDynamicObject(guid));
                break;
            case HIGHGUID_CORPSE:
                Eluna::Push(L, ObjectAccessor::GetObjectInMap(guid, map, (Corpse*)NULL));
                break;
            default:
                break;
        }
    ...
    {
        ElunaInstanceAI* iAI = dynamic_cast<ElunaInstanceAI*>(((InstanceMap*)map)->GetInstanceData());
