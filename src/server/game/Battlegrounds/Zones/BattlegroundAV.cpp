...
const char* BattlegroundAV::GetNodeName(BG_AV_Nodes node)
{
    ...
    case BG_AV_NODES_FIRSTAID_STATION:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_STORM_AID);
    case BG_AV_NODES_DUNBALDAR_SOUTH:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_DUN_S);
    case BG_AV_NODES_DUNBALDAR_NORTH:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_DUN_N);
    case BG_AV_NODES_STORMPIKE_GRAVE:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_STORMPIKE);
    case BG_AV_NODES_ICEWING_BUNKER:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_ICEWING);
    case BG_AV_NODES_STONEHEART_GRAVE:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_STONE);
    case BG_AV_NODES_STONEHEART_BUNKER:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_STONE);
    case BG_AV_NODES_SNOWFALL_GRAVE:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_SNOW);
    case BG_AV_NODES_ICEBLOOD_TOWER:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_ICE);
    case BG_AV_NODES_ICEBLOOD_GRAVE:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_ICE);
    case BG_AV_NODES_TOWER_POINT:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_POINT);
    case BG_AV_NODES_FROSTWOLF_GRAVE:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_FROST);
    case BG_AV_NODES_FROSTWOLF_ETOWER:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_FROST_E);
    case BG_AV_NODES_FROSTWOLF_WTOWER:
        return GetOregonString(LANG_BG_AV_NODE_TOWER_FROST_W);
    case BG_AV_NODES_FROSTWOLF_HUT:
        return GetOregonString(LANG_BG_AV_NODE_GRAVE_FROST_HUT);
    default:
