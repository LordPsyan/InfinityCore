...
void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
    ...
    if(sConfig.GetBoolDefault("BeastMaster.OnlyHunter", true)) // Checks to see if Only Hunters can have pets.
     {
...
{
    bool EnableNormalPet = sConfig.GetBoolDefault("BeastMaster.EnableNormalPet", true);
    bool EnableExoticPet = sConfig.GetBoolDefault("BeastMaster.EnableExoticPet", true);
